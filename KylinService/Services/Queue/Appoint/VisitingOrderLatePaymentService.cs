...
namespace KylinService.Services.Queue.Appoint
{
    ...
    /// 上门订单超时未支付服务
    /// </summary>
    public sealed class VisitingOrderLatePaymentService : QueueSchedulerService<VisitingOrderLateNoPaymentModel>
    {
        /// <summary>
        /// 初始化实例
        /// </summary>
        ...
        public VisitingOrderLatePaymentService() : base(QueueScheduleType.VisitingOrderLatePayment) { }
        ...
        protected override bool SingleRequest()
        {
            ...
            //获取一条待处理数据
            var model = RedisConfig.DataBase.ListLeftPop<VisitingOrderLateNoPaymentModel>(RedisConfig.Key);
        ...
        protected override void Execute(object state)
        {
            ...
            try
            {
                ...
                if (!statusRight) throw new CustomException(string.Format("〖上门订单（ID:{0}）〗状态已发生变更，不能自动完成收货！", lastOrder.OrderID));
