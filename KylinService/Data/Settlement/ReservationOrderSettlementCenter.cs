...
namespace KylinService.Data.Settlement
{
    ...
    /// 预约订单结算中心
    /// </summary>
    public class ReservationOrderSettlementCenter : SettlementCenter
    {
        /// <summary>
        /// 初始化预约订单结算实例
        /// </summary>
        ...
        public ReservationOrderSettlementCenter(long orderID, bool needProcessOrder)
        {
        ...
        /// <param name="needProcessOrder">是否需要处理订单</param>
        public ReservationOrderSettlementCenter(KylinService_Order order, bool needProcessOrder)
        {
            _order = order;
            _needProcessOrder = needProcessOrder;
        }
        ...
        public override void Execute()
        {
            ...
            if (_order.BusinessType != (int)BusinessServiceType.Reservation)
            {
                _errorMessage = "当前订单不是有效的预约服务订单！";
                return;
            }
